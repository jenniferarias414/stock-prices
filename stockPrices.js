...
// function best (stockArray){

//     let lowestPrice = stockArray[0]
//     let highestPrice = stockArray[0]
...
function best(stocks){
    let lowest; 
    // set as undefined, because we don't know what the lowest # will be, but it won't be 0
    let high = 0;
